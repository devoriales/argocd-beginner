# Module 5: Sync Strategies & Lifecycle Hooks
...
| # | Lesson | Artifacts |
| --- | --- | --- |
| 1 | Sync waves, ordering resource application | `01-*/` |
| 2 | PreSync / Sync / PostSync hooks | `02-*/` |
| 3 | PreDelete hooks, clean teardown patterns | `03-*/` |
| 4 | Hook deletion policies | `04-*/` |
| 5 | Progressive syncs for phased rollouts | `05-*/` |
