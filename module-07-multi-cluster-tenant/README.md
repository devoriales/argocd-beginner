...
| # | Lesson | Artifacts |
| --- | --- | --- |
| 1 | Registering external clusters | `01-*/` |
| 2 | RBAC model: projects, roles, policy.csv | `02-*/` |
| 3 | SSO integration (Dex, OIDC) | `03-*/` |
| 4 | Namespace-scoped vs. cluster-scoped installs | `04-*/` |
| 5 | Resource restriction with AppProject | `05-*/` |
