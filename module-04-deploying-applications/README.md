...
| # | Lesson | Artifacts |
| --- | --- | --- |
| 1 | Deploying a plain-YAML app | `01-*/` |
| 2 | Deploying with Kustomize | `02-*/` |
| 3 | Deploying with Helm charts | `03-*/` |
| 4 | Deploying OCI-packaged Helm charts | `04-*/` |
| 5 | Manual sync vs. auto-sync, self-heal, and prune | `05-*/` |
